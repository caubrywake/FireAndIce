...
imdir=  'D:\FireandIce\data_raw\moraine_timelapse\2019\';
...
t1 = find(d == datetime('01-Jul-2019 11:00:02'));
t2 = find(d == datetime('15-Sep-2019 17:00:02'));
...
% [val, idx_smoky_clear] = clicksubplot_keeph;% 2019 didnt have any fire
...
figure; plot(all_idx); 
% missed 
idx_sunny = sort([idx_sunny 105]); % 
idx_cloudy =sort([idx_cloudy 161 183 ]); % 
idx_mixed = sort([idx_mixed 95 187]); %
...
IDX_str_2019 = IDX_str;
IDX_2019=IDX;
t2019 = t; 
writetable( T, strcat(dirsave, 'Table_TimelapseImageWeatherType_2019.txt'))
save(strcat(dirsave, 'TimelapseImageWeatherType_2019.mat'), 'IDX_2019', 'IDX_str_2019', 't2019')
